                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <input type="text" id="street_number" class="form-control" name="street_number"
                                value="{{ old('street_number') }}" placeholder="Street number" required>
                            @error('street_number')
                                <p>{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <input type="text" id="street_name" class="form-control" name="street_name"
                                value="{{ old('street_name') }}" placeholder="Street name" required>
                            @error('street_name')
                                <p>{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <input type="text" id="ssn" class="form-control" name="ssn"
                                value="{{ old('ssn') }}" placeholder="SSN" required>
                            @error('ssn')
                                <p>{{ $message }}</p>
                            @enderror
                        </div>
